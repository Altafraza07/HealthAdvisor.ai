  ...
  return (
    <div className="relative bg-gradient-to-r from-teal-600 to-teal-500 py-20 px-6 overflow-hidden z-0">
      ...
      <div className="max-w-6xl mx-auto bg-white/60 backdrop-blur-lg p-12 rounded-3xl shadow-xl border border-white/30 relative z-[5] mb-20">
        ...
        >
          Health Advisor.AI is your intelligent virtual health companion. It
          empowers users with instant, personalized health insights through a
          smart symptom checker, AI-powered recommendations, and expert
          consultation booking — all in one place.
        </motion.p>
      ...
      <div className="max-w-5xl mx-auto text-center relative z-[5]">
        ...
        >
          Passionate about crafting innovative solutions, We combine creativity
          with cutting-edge technology to make digital health tools smarter and
          more accessible.
        </motion.p>
        ...
        >
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-teal-500 font-medium">Full Stack Developer</p>
            <p className="text-gray-600 text-center max-w-md">
              I’m focused on building intuitive, AI-driven solutions like Health
              Advisor.AI to empower users with instant health insights. Let’s
              build the future of digital wellness together.
            </p>
        ...
        >
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-teal-500 font-medium">Full Stack Developer</p>
            <p className="text-gray-600 text-center max-w-md">
              I have expertise in developing e-commerce platforms, AI-based
              tools, and responsive web apps. I am a dedicated Full-Stack
              Developer with a focus on the MERN stack. I enjoy simplifying
              difficult issues into scalable, clean code.{" "}
            </p>

            {/* Social Links */}
            <div className="flex justify-center gap-4 mt-4">
              <a
                href="https://www.linkedin.com/in/altafraza07 "
                target="_blank"
                rel="noopener noreferrer"
                className="text-teal-600 hover:text-teal-800 text-xl transition"
              >
              ...
              <a
                href="https://github.com/Altafraza07"
                target="_blank"
                rel="noopener noreferrer"
                className="text-teal-600 hover:text-teal-800 text-xl transition"
              >
